...
SerialPeaker questionCounter = new SerialPeaker();
examBuilder.RegisterMacro("QuestionCounter", (_) =>
    questionCounter.NextSerial().ToString());


examBuilder.AddExam();
examBuilder.AddQuestion("#SerialNumber",5);
/*
